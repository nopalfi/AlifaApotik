...
Begin VB.Form FrmSatuan 
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "Select * From satuan"
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
...
Private Sub Command2_Click()
    ...
    Adodc1.Recordset.Fields!satuan = Text1.Text
...
Private Sub Text1_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        If Not Adodc1.Recordset.EOF Then
            Adodc1.RecordSource = "Select * from Kategori where satuan ='" & Text1.Text & "'"
            Adodc1.Refresh
